...
import { setFeatures } from "./../../Redux/features/featureSlice";
...
export default function DashboardCompany() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:5555/auth/navics/companies/accessCompanyFeatures/${currentUser.company_id}`)
      .then((res) => {
  ...
  const onMenuClick = (id) => {
    setActiveMenu(id);
    const path = id === "dashboard" ? "/company" : `/company/${id}`;
